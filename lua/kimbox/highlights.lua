...
hl.langs.markdown = {
    ...
    markdownListMarker = {fg = c.red, gui = bold},
...
hl.langs08.markdown = {
    ...
    ["@text.literal.markdown_inline"] = {link = "TSCode"},
    ["@markup.raw.markdown_inline"] = {link = "TSCode"},
    ["@markup.raw.block.markdown"] = {link = "markdownCodeBlock"},
    ["@markup.list.markdown"] = {link = "markdownListMarker"},
    ["@markup.heading.1.markdown"] = {link = "Title1"},
    ["@markup.heading.2.markdown"] = {link = "Title2"},
    ["@markup.heading.3.markdown"] = {link = "Title3"},
    ["@markup.heading.4.markdown"] = {link = "Title4"},
    ["@markup.heading.5.markdown"] = {link = "Title5"},
    ["@markup.heading.6.markdown"] = {link = "Title6"},
...
hl.langs.rust = {
    ...
    rustDynKeyword = {link = "Keyword"},
    rustAsync = {link = "Keyword"},
    rustAwait = {link = "rustAsync"},
    rustStructure = {link = "Structure"},
    rustUnion = {link = "Structure"},
    rustIdentifier = {link = "TSTypeBuiltin"},
    rustExistential = {link = "rustIdentifier"},
    rustCapsIdent = {link = "TSConstant"},
    rustConstant = {link = "TSConstant"},
    rustTypedef = {link = "Typedef"},
    rustType = {link = "Type"},
    rustTrait = {link = "rustType"},
    rustDeriveTrait = {link = "rustType"},
    rustConditional = {link = "Conditional"},
    rustBoolean = {link = "Boolean"},
    rustRepeat = {link = "Conditional"},
    ...
    rustPubScopeCrate = {link = "TSNamespace"},
    rustPubScopeDelim = {link = "Delimiter"},
    rustQuestionMark = {link = "Operator"},
    rustArrowCharacter = {link = "Operator"},
    rustOperator = {link = "Operator"},
    rustSigil = {link = "Operator"},
    rustLabel = {link = "rustTSLabel"},
    rustLifetime = {link = "rustTSLabel"},
    -- === Treesitter ===
...
hl.langs.vim = {
    ...
    -- vimNotFunc = {fg = c.red, gui = bold}, -- if/else/return
    -- === Treesitter ===
...
hl.plugins.diffview = {
    ...
    DiffviewFilePanelConflicts = {link = "TSWarn"},
    DiffviewFilePanelDeletions = fgs.red,
    DiffviewFilePanelFileName = {link = "Title"},
    DiffviewFilePanelInsertions = fgs.green,
    DiffviewFilePanelPath = {link = "Directory"},
    DiffviewFilePanelRootPath = {link = "TSConstant"},
    DiffviewFilePanelTitle = {link = "TSNote"},
    ...
    DiffviewStatusRenamed = {link = "GitSignsChangedelete"},
    DiffviewStatusTypeChange = {link = "Character"},
    DiffviewStatusUnknown = fgs.teaberry,
    DiffviewStatusUnmerged = fgs.amethyst,
    DiffviewStatusUntracked = {link = "GitSignsUntracked"},
    DiffviewStatusIgnored = fgs.beaver,
    DiffviewPrimary = fgs.magenta,
    DiffviewSecondary = fgs.yellow,
    DiffviewDim1 = {link = "Comment"},
    DiffviewDiffAdd = {link = "DiffAdd"},
    DiffviewDiffAddAsDelete = {link = "DiffAdd"},
