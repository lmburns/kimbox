...
if s:configuration.transparent_background
  call kimbox#highlight('Normal', s:palette.fg0, s:palette.none)
  call kimbox#highlight('Terminal', s:palette.fg0, s:palette.none)
  call kimbox#highlight('EndOfBuffer', s:palette.bg0, s:palette.none)
  call kimbox#highlight('FoldColumn', s:palette.grey0, s:palette.none)
  call kimbox#highlight('Folded', s:palette.grey1, s:palette.none)
  call kimbox#highlight('SignColumn', s:palette.fg0, s:palette.none)
  call kimbox#highlight('ToolbarLine', s:palette.fg0, s:palette.none)
else
  call kimbox#highlight('Normal', s:palette.fg0, s:palette.bg0)
  call kimbox#highlight('Terminal', s:palette.fg0, s:palette.bg0)
  call kimbox#highlight('EndOfBuffer', s:palette.bg0, s:palette.bg0)
  call kimbox#highlight('Folded', s:palette.grey1, s:palette.bg2)
  call kimbox#highlight('ToolbarLine', s:palette.fg1, s:palette.bg3)
  if s:configuration.sign_column_background ==# 'default'
    call kimbox#highlight('SignColumn', s:palette.fg0, s:palette.bg2)
    call kimbox#highlight('FoldColumn', s:palette.grey0, s:palette.bg2)
  else
    call kimbox#highlight('SignColumn', s:palette.fg0, s:palette.none)
    call kimbox#highlight('FoldColumn', s:palette.grey0, s:palette.none)
  endif
endif
call kimbox#highlight('IncSearch', s:palette.bg0, s:palette.bg_red)
call kimbox#highlight('Search', s:palette.bg0, s:palette.bg_green)
call kimbox#highlight('ColorColumn', s:palette.none, s:palette.bg2)
call kimbox#highlight('Conceal', s:palette.grey0, s:palette.none)
if s:configuration.cursor ==# 'auto'
  call kimbox#highlight('Cursor', s:palette.none, s:palette.none, 'reverse')
else
  call kimbox#highlight('Cursor', s:palette.bg0, s:palette[s:configuration.cursor])
endif
...
if &diff
  call kimbox#highlight('CursorLine', s:palette.none, s:palette.none, 'underline')
  call kimbox#highlight('CursorColumn', s:palette.none, s:palette.none, 'bold')
else
  call kimbox#highlight('CursorLine', s:palette.none, s:palette.bg1)
  call kimbox#highlight('CursorColumn', s:palette.none, s:palette.bg1)
endif
call kimbox#highlight('LineNr', s:palette.grey0, s:palette.none)
if &diff
  call kimbox#highlight('CursorLineNr', s:palette.grey2, s:palette.none, 'underline')
elseif (&relativenumber == 1 && &cursorline == 0) || s:configuration.sign_column_background !=# 'default'
  call kimbox#highlight('CursorLineNr', s:palette.grey2, s:palette.none)
else
  call kimbox#highlight('CursorLineNr', s:palette.grey2, s:palette.bg1)
endif
call kimbox#highlight('DiffAdd', s:palette.none, s:palette.bg_diff_green)
call kimbox#highlight('DiffChange', s:palette.none, s:palette.bg_diff_blue)
call kimbox#highlight('DiffDelete', s:palette.none, s:palette.bg_diff_red)
call kimbox#highlight('DiffText', s:palette.bg0, s:palette.fg0)
call kimbox#highlight('Directory', s:palette.green, s:palette.none)
call kimbox#highlight('ErrorMsg', s:palette.red, s:palette.none, 'bold,underline')
call kimbox#highlight('WarningMsg', s:palette.yellow, s:palette.none, 'bold')
call kimbox#highlight('ModeMsg', s:palette.fg0, s:palette.none, 'bold')
call kimbox#highlight('MoreMsg', s:palette.yellow, s:palette.none, 'bold')
call kimbox#highlight('MatchParen', s:palette.none, s:palette.bg4)
call kimbox#highlight('NonText', s:palette.bg5, s:palette.none)
call kimbox#highlight('Whitespace', s:palette.bg5, s:palette.none)
call kimbox#highlight('SpecialKey', s:palette.bg5, s:palette.none)
call kimbox#highlight('Pmenu', s:palette.fg1, s:palette.bg3)
call kimbox#highlight('PmenuSbar', s:palette.none, s:palette.bg3)
if s:configuration.menu_selection_background ==# 'grey'
  call kimbox#highlight('PmenuSel', s:palette.bg3, s:palette.grey2)
elseif s:configuration.menu_selection_background ==# 'green'
  call kimbox#highlight('PmenuSel', s:palette.bg3, s:palette.bg_green)
elseif s:configuration.menu_selection_background ==# 'red'
  call kimbox#highlight('PmenuSel', s:palette.bg3, s:palette.bg_red)
else
  call kimbox#highlight('PmenuSel', s:palette.bg3, s:palette[s:configuration.menu_selection_background])
end
highlight! link WildMenu PmenuSel
call kimbox#highlight('PmenuThumb', s:palette.none, s:palette.grey0)
call kimbox#highlight('NormalFloat', s:palette.fg1, s:palette.bg3)
call kimbox#highlight('Question', s:palette.yellow, s:palette.none)
call kimbox#highlight('SpellBad', s:palette.red, s:palette.none, 'undercurl', s:palette.red)
call kimbox#highlight('SpellCap', s:palette.blue, s:palette.none, 'undercurl', s:palette.blue)
call kimbox#highlight('SpellLocal', s:palette.aqua, s:palette.none, 'undercurl', s:palette.aqua)
call kimbox#highlight('SpellRare', s:palette.purple, s:palette.none, 'undercurl', s:palette.purple)
if s:configuration.statusline_style ==# 'original'
  call kimbox#highlight('StatusLine', s:palette.grey2, s:palette.bg_statusline3)
  call kimbox#highlight('StatusLineTerm', s:palette.grey2, s:palette.bg_statusline3)
  call kimbox#highlight('StatusLineNC', s:palette.grey1, s:palette.bg_statusline2)
  call kimbox#highlight('StatusLineTermNC', s:palette.grey1, s:palette.bg_statusline2)
  call kimbox#highlight('TabLine', s:palette.grey2, s:palette.bg_statusline3)
  call kimbox#highlight('TabLineFill', s:palette.grey1, s:palette.bg0)
  call kimbox#highlight('TabLineSel', s:palette.bg0, s:palette.grey2)
else
  call kimbox#highlight('StatusLine', s:palette.fg1, s:palette.bg_statusline2)
  call kimbox#highlight('StatusLineTerm', s:palette.fg1, s:palette.bg_statusline2)
  call kimbox#highlight('StatusLineNC', s:palette.grey2, s:palette.bg_statusline2)
  call kimbox#highlight('StatusLineTermNC', s:palette.grey2, s:palette.bg_statusline2)
  call kimbox#highlight('TabLine', s:palette.fg1, s:palette.bg_statusline3)
  call kimbox#highlight('TabLineFill', s:palette.fg0, s:palette.bg_statusline1)
  call kimbox#highlight('TabLineSel', s:palette.bg0, s:palette.grey2)
endif
call kimbox#highlight('VertSplit', s:palette.bg5, s:palette.none)
if s:configuration.visual ==# 'grey background'
  call kimbox#highlight('Visual', s:palette.none, s:palette.bg3)
  call kimbox#highlight('VisualNOS', s:palette.none, s:palette.bg3)
elseif s:configuration.visual ==# 'green background'
  call kimbox#highlight('Visual', s:palette.none, s:palette.bg_visual_green)
  call kimbox#highlight('VisualNOS', s:palette.none, s:palette.bg_visual_green)
elseif s:configuration.visual ==# 'blue background'
  call kimbox#highlight('Visual', s:palette.none, s:palette.bg_visual_blue)
  call kimbox#highlight('VisualNOS', s:palette.none, s:palette.bg_visual_blue)
elseif s:configuration.visual ==# 'red background'
  call kimbox#highlight('Visual', s:palette.none, s:palette.bg_visual_red)
  call kimbox#highlight('VisualNOS', s:palette.none, s:palette.bg_visual_red)
elseif s:configuration.visual ==# 'reverse'
  call kimbox#highlight('Visual', s:palette.none, s:palette.none, 'reverse')
  call kimbox#highlight('VisualNOS', s:palette.none, s:palette.none, 'reverse')
endif
call kimbox#highlight('QuickFixLine', s:palette.purple, s:palette.none, 'bold')
call kimbox#highlight('Debug', s:palette.orange, s:palette.none)
call kimbox#highlight('debugPC', s:palette.bg0, s:palette.green)
call kimbox#highlight('debugBreakpoint', s:palette.bg0, s:palette.red)
call kimbox#highlight('ToolbarButton', s:palette.bg0, s:palette.grey2)
if has('nvim')
  call kimbox#highlight('Substitute', s:palette.bg0, s:palette.yellow)
...
" }}}
" Syntax: {{{
call kimbox#highlight('Boolean', s:palette.purple, s:palette.none)
call kimbox#highlight('Number', s:palette.purple, s:palette.none)
call kimbox#highlight('Float', s:palette.purple, s:palette.none)
if s:configuration.enable_italic
  call kimbox#highlight('PreProc', s:palette.purple, s:palette.none, 'italic')
  call kimbox#highlight('PreCondit', s:palette.purple, s:palette.none, 'italic')
  call kimbox#highlight('Include', s:palette.purple, s:palette.none, 'italic')
  call kimbox#highlight('Define', s:palette.purple, s:palette.none, 'italic')
  call kimbox#highlight('Conditional', s:palette.red, s:palette.none, 'italic')
  call kimbox#highlight('Repeat', s:palette.red, s:palette.none, 'italic')
  call kimbox#highlight('Keyword', s:palette.red, s:palette.none, 'italic')
  call kimbox#highlight('Typedef', s:palette.red, s:palette.none, 'italic')
  call kimbox#highlight('Exception', s:palette.red, s:palette.none, 'italic')
  call kimbox#highlight('Statement', s:palette.red, s:palette.none, 'italic')
else
  call kimbox#highlight('PreProc', s:palette.purple, s:palette.none)
  call kimbox#highlight('PreCondit', s:palette.purple, s:palette.none)
  call kimbox#highlight('Include', s:palette.purple, s:palette.none)
  call kimbox#highlight('Define', s:palette.purple, s:palette.none)
  call kimbox#highlight('Conditional', s:palette.red, s:palette.none)
  call kimbox#highlight('Repeat', s:palette.red, s:palette.none)
  call kimbox#highlight('Keyword', s:palette.red, s:palette.none)
  call kimbox#highlight('Typedef', s:palette.red, s:palette.none)
  call kimbox#highlight('Exception', s:palette.red, s:palette.none)
  call kimbox#highlight('Statement', s:palette.red, s:palette.none)
endif
call kimbox#highlight('Error', s:palette.red, s:palette.none)
call kimbox#highlight('StorageClass', s:palette.orange, s:palette.none)
call kimbox#highlight('Tag', s:palette.orange, s:palette.none)
call kimbox#highlight('Label', s:palette.orange, s:palette.none)
call kimbox#highlight('Structure', s:palette.orange, s:palette.none)
call kimbox#highlight('Operator', s:palette.orange, s:palette.none)
call kimbox#highlight('Title', s:palette.orange, s:palette.none, 'bold')
call kimbox#highlight('Special', s:palette.yellow, s:palette.none)
call kimbox#highlight('SpecialChar', s:palette.yellow, s:palette.none)
call kimbox#highlight('Type', s:palette.yellow, s:palette.none)
if s:configuration.enable_bold
  call kimbox#highlight('Function', s:palette.green, s:palette.none, 'bold')
else
  call kimbox#highlight('Function', s:palette.green, s:palette.none)
endif
call kimbox#highlight('String', s:palette.green, s:palette.none)
call kimbox#highlight('Character', s:palette.green, s:palette.none)
call kimbox#highlight('Constant', s:palette.aqua, s:palette.none)
call kimbox#highlight('Macro', s:palette.aqua, s:palette.none)
call kimbox#highlight('Identifier', s:palette.blue, s:palette.none)
if s:configuration.disable_italic_comment
  call kimbox#highlight('Comment', s:palette.grey1, s:palette.none)
  call kimbox#highlight('SpecialComment', s:palette.grey1, s:palette.none)
  call kimbox#highlight('Todo', s:palette.purple, s:palette.none)
else
  call kimbox#highlight('Comment', s:palette.grey1, s:palette.none, 'italic')
  call kimbox#highlight('SpecialComment', s:palette.grey1, s:palette.none, 'italic')
  call kimbox#highlight('Todo', s:palette.purple, s:palette.none, 'italic')
endif
call kimbox#highlight('Delimiter', s:palette.fg0, s:palette.none)
call kimbox#highlight('Ignore', s:palette.grey1, s:palette.none)
call kimbox#highlight('Underlined', s:palette.none, s:palette.none, 'underline')
" }}}
" Predefined Highlight Groups: {{{
call kimbox#highlight('Fg', s:palette.fg0, s:palette.none)
call kimbox#highlight('Grey', s:palette.grey1, s:palette.none)
call kimbox#highlight('Red', s:palette.red, s:palette.none)
call kimbox#highlight('Orange', s:palette.orange, s:palette.none)
call kimbox#highlight('Yellow', s:palette.yellow, s:palette.none)
call kimbox#highlight('Green', s:palette.green, s:palette.none)
call kimbox#highlight('Aqua', s:palette.aqua, s:palette.none)
call kimbox#highlight('Blue', s:palette.blue, s:palette.none)
call kimbox#highlight('Purple', s:palette.purple, s:palette.none)
if s:configuration.enable_italic
  call kimbox#highlight('RedItalic', s:palette.red, s:palette.none, 'italic')
  call kimbox#highlight('OrangeItalic', s:palette.orange, s:palette.none, 'italic')
  call kimbox#highlight('YellowItalic', s:palette.yellow, s:palette.none, 'italic')
  call kimbox#highlight('GreenItalic', s:palette.green, s:palette.none, 'italic')
  call kimbox#highlight('AquaItalic', s:palette.aqua, s:palette.none, 'italic')
  call kimbox#highlight('BlueItalic', s:palette.blue, s:palette.none, 'italic')
  call kimbox#highlight('PurpleItalic', s:palette.purple, s:palette.none, 'italic')
else
  call kimbox#highlight('RedItalic', s:palette.red, s:palette.none)
  call kimbox#highlight('OrangeItalic', s:palette.orange, s:palette.none)
  call kimbox#highlight('YellowItalic', s:palette.yellow, s:palette.none)
  call kimbox#highlight('GreenItalic', s:palette.green, s:palette.none)
  call kimbox#highlight('AquaItalic', s:palette.aqua, s:palette.none)
  call kimbox#highlight('BlueItalic', s:palette.blue, s:palette.none)
  call kimbox#highlight('PurpleItalic', s:palette.purple, s:palette.none)
endif
if s:configuration.enable_bold
  call kimbox#highlight('RedBold', s:palette.red, s:palette.none, 'bold')
  call kimbox#highlight('OrangeBold', s:palette.orange, s:palette.none, 'bold')
  call kimbox#highlight('YellowBold', s:palette.yellow, s:palette.none, 'bold')
  call kimbox#highlight('GreenBold', s:palette.green, s:palette.none, 'bold')
  call kimbox#highlight('AquaBold', s:palette.aqua, s:palette.none, 'bold')
  call kimbox#highlight('BlueBold', s:palette.blue, s:palette.none, 'bold')
  call kimbox#highlight('PurpleBold', s:palette.purple, s:palette.none, 'bold')
else
  call kimbox#highlight('RedBold', s:palette.red, s:palette.none)
  call kimbox#highlight('OrangeBold', s:palette.orange, s:palette.none)
  call kimbox#highlight('YellowBold', s:palette.yellow, s:palette.none)
  call kimbox#highlight('GreenBold', s:palette.green, s:palette.none)
  call kimbox#highlight('AquaBold', s:palette.aqua, s:palette.none)
  call kimbox#highlight('BlueBold', s:palette.blue, s:palette.none)
  call kimbox#highlight('PurpleBold', s:palette.purple, s:palette.none)
endif
if s:configuration.transparent_background || s:configuration.sign_column_background !=# 'default'
  call kimbox#highlight('RedSign', s:palette.red, s:palette.none)
  call kimbox#highlight('OrangeSign', s:palette.orange, s:palette.none)
  call kimbox#highlight('YellowSign', s:palette.yellow, s:palette.none)
  call kimbox#highlight('GreenSign', s:palette.green, s:palette.none)
  call kimbox#highlight('AquaSign', s:palette.aqua, s:palette.none)
  call kimbox#highlight('BlueSign', s:palette.blue, s:palette.none)
  call kimbox#highlight('PurpleSign', s:palette.purple, s:palette.none)
else
  call kimbox#highlight('RedSign', s:palette.red, s:palette.bg2)
  call kimbox#highlight('OrangeSign', s:palette.orange, s:palette.bg2)
  call kimbox#highlight('YellowSign', s:palette.yellow, s:palette.bg2)
  call kimbox#highlight('GreenSign', s:palette.green, s:palette.bg2)
  call kimbox#highlight('AquaSign', s:palette.aqua, s:palette.bg2)
  call kimbox#highlight('BlueSign', s:palette.blue, s:palette.bg2)
  call kimbox#highlight('PurpleSign', s:palette.purple, s:palette.bg2)
endif
if s:configuration.diagnostic_text_highlight
  call kimbox#highlight('ErrorText', s:palette.none, s:palette.bg_visual_red, 'undercurl', s:palette.red)
  call kimbox#highlight('WarningText', s:palette.none, s:palette.bg_visual_yellow, 'undercurl', s:palette.yellow)
  call kimbox#highlight('InfoText', s:palette.none, s:palette.bg_visual_blue, 'undercurl', s:palette.blue)
  call kimbox#highlight('HintText', s:palette.none, s:palette.bg_visual_green, 'undercurl', s:palette.green)
else
  call kimbox#highlight('ErrorText', s:palette.none, s:palette.none, 'undercurl', s:palette.red)
  call kimbox#highlight('WarningText', s:palette.none, s:palette.none, 'undercurl', s:palette.yellow)
  call kimbox#highlight('InfoText', s:palette.none, s:palette.none, 'undercurl', s:palette.blue)
  call kimbox#highlight('HintText', s:palette.none, s:palette.none, 'undercurl', s:palette.green)
endif
if s:configuration.diagnostic_line_highlight
  call kimbox#highlight('ErrorLine', s:palette.none, s:palette.bg_visual_red)
  call kimbox#highlight('WarningLine', s:palette.none, s:palette.bg_visual_yellow)
  call kimbox#highlight('InfoLine', s:palette.none, s:palette.bg_visual_blue)
  call kimbox#highlight('HintLine', s:palette.none, s:palette.bg_visual_green)
else
...
call kimbox#highlight('ErrorFloat', s:palette.red, s:palette.bg3)
call kimbox#highlight('WarningFloat', s:palette.yellow, s:palette.bg3)
call kimbox#highlight('InfoFloat', s:palette.blue, s:palette.bg3)
call kimbox#highlight('HintFloat', s:palette.green, s:palette.bg3)
if &diff
  call kimbox#highlight('CurrentWord', s:palette.bg0, s:palette.bg_green)
elseif s:configuration.current_word ==# 'grey background'
  call kimbox#highlight('CurrentWord', s:palette.none, s:palette.bg_current_word)
else
  call kimbox#highlight('CurrentWord', s:palette.none, s:palette.none, s:configuration.current_word)
endif
" }}}
" }}}
" Terminal: {{{
...
call kimbox#highlight('TSEmphasis', s:palette.none, s:palette.none, 'bold')
call kimbox#highlight('TSUnderline', s:palette.none, s:palette.none, 'underline')
...
" }}}
" neoclide/coc.nvim {{{
call kimbox#highlight('CocHoverRange', s:palette.none, s:palette.none, 'bold,underline')
...
if !exists('g:Lf_StlColorscheme')
  let g:Lf_StlColorscheme = 'kimbox'
endif
if !exists('g:Lf_PopupColorscheme')
  let g:Lf_PopupColorscheme = 'kimbox'
endif
call kimbox#highlight('Lf_hl_match', s:palette.green, s:palette.none, 'bold')
call kimbox#highlight('Lf_hl_match0', s:palette.green, s:palette.none, 'bold')
call kimbox#highlight('Lf_hl_match1', s:palette.aqua, s:palette.none, 'bold')
call kimbox#highlight('Lf_hl_match2', s:palette.blue, s:palette.none, 'bold')
call kimbox#highlight('Lf_hl_match3', s:palette.purple, s:palette.none, 'bold')
call kimbox#highlight('Lf_hl_match4', s:palette.orange, s:palette.none, 'bold')
call kimbox#highlight('Lf_hl_matchRefine', s:palette.red, s:palette.none, 'bold')
...
" }}}
" Shougo/denite.nvim {{{
call kimbox#highlight('deniteMatchedChar', s:palette.green, s:palette.none, 'bold')
call kimbox#highlight('deniteMatchedRange', s:palette.green, s:palette.none, 'bold,underline')
call kimbox#highlight('deniteInput', s:palette.green, s:palette.bg4, 'bold')
call kimbox#highlight('deniteStatusLineNumber', s:palette.purple, s:palette.bg4)
call kimbox#highlight('deniteStatusLinePath', s:palette.fg0, s:palette.bg4)
highlight! link deniteSelectedLin Green
" }}}
" kien/ctrlp.vim {{{
call kimbox#highlight('CtrlPMatch', s:palette.green, s:palette.none, 'bold')
call kimbox#highlight('CtrlPPrtBase', s:palette.bg4, s:palette.none)
call kimbox#highlight('CtrlPLinePre', s:palette.bg4, s:palette.none)
call kimbox#highlight('CtrlPMode1', s:palette.blue, s:palette.bg4, 'bold')
call kimbox#highlight('CtrlPMode2', s:palette.bg0, s:palette.blue, 'bold')
call kimbox#highlight('CtrlPStats', s:palette.grey2, s:palette.bg4, 'bold')
...
call kimbox#highlight('MatchParenCur', s:palette.none, s:palette.none, 'bold')
call kimbox#highlight('MatchWord', s:palette.none, s:palette.none, 'underline')
call kimbox#highlight('MatchWordCur', s:palette.none, s:palette.none, 'underline')
" }}}
...
" }}}
" justinmk/vim-sneak {{{
call kimbox#highlight('SneakLabelMask', s:palette.bg_green, s:palette.bg_green)
...
if get(g:, 'indent_guides_auto_colors', 1) == 0
  call kimbox#highlight('IndentGuidesOdd', s:palette.bg0, s:palette.bg2)
  call kimbox#highlight('IndentGuidesEven', s:palette.bg0, s:palette.bg3)
endif
" }}}
" luochen1990/rainbow {{{
...
call kimbox#highlight('QuickScopePrimary', s:palette.aqua, s:palette.none, 'underline')
call kimbox#highlight('QuickScopeSecondary', s:palette.blue, s:palette.none, 'underline')
" }}}
" APZelos/blamer.nvim {{{
...
" For example, the content between `ft_begin: sh/zsh` and `ft_end` will be placed in `after/ftplugin/sh/kimbox.vim` and `after/ftplugin/zsh/kimbox.vim`.
if kimbox#ft_exists(s:path) " If the ftplugin exists.
  if s:configuration.better_performance
    if !kimbox#ft_newest(s:path, s:last_modified) " Regenerate if it's not up to date.
      call kimbox#ft_clean(s:path, 0)
      call kimbox#ft_gen(s:path, s:last_modified, 'update')
    endif
    finish
  else
    call kimbox#ft_clean(s:path, 1)
  endif
else
  if s:configuration.better_performance
    call kimbox#ft_gen(s:path, s:last_modified, 'generate')
    finish
  endif
endif
" ft_begin: vim-plug {{{
" https://github.com/junegunn/vim-plug
call kimbox#highlight('plug1', s:palette.orange, s:palette.none, 'bold')
call kimbox#highlight('plugNumber', s:palette.yellow, s:palette.none, 'bold')
...
call kimbox#highlight('UndotreeSavedBig', s:palette.purple, s:palette.none, 'bold')
...
" ft_begin: markdown {{{
" builtin: {{{
call kimbox#highlight('markdownH1', s:palette.red, s:palette.none, 'bold')
call kimbox#highlight('markdownH2', s:palette.orange, s:palette.none, 'bold')
call kimbox#highlight('markdownH3', s:palette.yellow, s:palette.none, 'bold')
call kimbox#highlight('markdownH4', s:palette.green, s:palette.none, 'bold')
call kimbox#highlight('markdownH5', s:palette.blue, s:palette.none, 'bold')
call kimbox#highlight('markdownH6', s:palette.purple, s:palette.none, 'bold')
call kimbox#highlight('markdownUrl', s:palette.blue, s:palette.none, 'underline')
call kimbox#highlight('markdownItalic', s:palette.none, s:palette.none, 'italic')
call kimbox#highlight('markdownBold', s:palette.none, s:palette.none, 'bold')
call kimbox#highlight('markdownItalicDelimiter', s:palette.grey1, s:palette.none, 'italic')
...
call kimbox#highlight('mkdURL', s:palette.blue, s:palette.none, 'underline')
call kimbox#highlight('mkdInlineURL', s:palette.purple, s:palette.none, 'underline')
call kimbox#highlight('mkdItalic', s:palette.grey1, s:palette.none, 'italic')
...
call kimbox#highlight('rstStandaloneHyperlink', s:palette.purple, s:palette.none, 'underline')
...
call kimbox#highlight('htmlH1', s:palette.red, s:palette.none, 'bold')
call kimbox#highlight('htmlH2', s:palette.orange, s:palette.none, 'bold')
call kimbox#highlight('htmlH3', s:palette.yellow, s:palette.none, 'bold')
call kimbox#highlight('htmlH4', s:palette.green, s:palette.none, 'bold')
call kimbox#highlight('htmlH5', s:palette.blue, s:palette.none, 'bold')
call kimbox#highlight('htmlH6', s:palette.purple, s:palette.none, 'bold')
call kimbox#highlight('htmlLink', s:palette.none, s:palette.none, 'underline')
call kimbox#highlight('htmlBold', s:palette.none, s:palette.none, 'bold')
call kimbox#highlight('htmlBoldUnderline', s:palette.none, s:palette.none, 'bold,underline')
call kimbox#highlight('htmlBoldItalic', s:palette.none, s:palette.none, 'bold,italic')
call kimbox#highlight('htmlBoldUnderlineItalic', s:palette.none, s:palette.none, 'bold,underline,italic')
call kimbox#highlight('htmlUnderline', s:palette.none, s:palette.none, 'underline')
call kimbox#highlight('htmlUnderlineItalic', s:palette.none, s:palette.none, 'underline,italic')
call kimbox#highlight('htmlItalic', s:palette.none, s:palette.none, 'italic')
...
call kimbox#highlight('semshiUnresolved', s:palette.yellow, s:palette.none, 'undercurl')
...
" ft_end }}}
" ft_begin: vim {{{
call kimbox#highlight('vimCommentTitle', s:palette.grey1, s:palette.none, 'bold')
...
" ft_end }}}
" ft_begin: toml {{{
call kimbox#highlight('tomlTable', s:palette.purple, s:palette.none, 'bold')
...
" ft_end }}}
" ft_begin: dosini {{{
call kimbox#highlight('dosiniHeader', s:palette.red, s:palette.none, 'bold')
highlight! link dosiniLabel Yellow
highlight! link dosiniValue Green
highlight! link dosiniNumber Green
" ft_end }}}
" ft_begin: help {{{
call kimbox#highlight('helpNote', s:palette.purple, s:palette.none, 'bold')
call kimbox#highlight('helpHeadline', s:palette.red, s:palette.none, 'bold')
call kimbox#highlight('helpHeader', s:palette.orange, s:palette.none, 'bold')
call kimbox#highlight('helpURL', s:palette.green, s:palette.none, 'underline')
call kimbox#highlight('helpHyperTextEntry', s:palette.yellow, s:palette.none, 'bold')
